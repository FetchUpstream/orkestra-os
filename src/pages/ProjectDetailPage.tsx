...
const ProjectDetailPage: Component = () => {
  ...
  const otherRepos = () =>
    project()?.repositories.filter((r) => !r.is_default) ?? [];
  const taskDisplayKey = (task: Task) => {
            ...
            {(projectValue) => (
              <div class="project-detail-container">
                ...
                <section class="projects-panel" aria-labelledby="tasks-heading">
                  ...
                  <Show
                    when={!taskError()}
                    fallback={<p class="projects-error">{taskError()}</p>}
                  >
                    <Show
                      when={!isTasksLoading()}
                      fallback={
                      ...
                      <form class="projects-form" onSubmit={onCreateTask}>
                        ...
                        <div class="projects-field">
                          ...
                          <select
                            ...
                            onChange={(event) =>
                              setTargetRepositoryId(event.currentTarget.value)
                            }
                          >
