...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            app::commands::runs::list_run_opencode_question_requests,
            app::commands::runs::reply_run_opencode_question,
            app::commands::runs::reject_run_opencode_question,
